...
import { NDSceneBufferRuntime, NDSceneCommitRuntime, NDSceneEdgeRuntime, NDSceneGraphRuntime, NDSceneNodeRuntime, NDSceneRuntime, NDTensorRuntime, NDTensorShapeEntryRuntime, } from "./ndsceneRuntime.js";
...
export function runtimeToFlatbufferBuffer(runtime) {
    return serializeRuntimeToFlatbuffer(runtime);
}
export function runtimeFromFlatbufferBuffer(buffer) {
...
export function runtimeFromLegacyJsonSequence(commits) {
    if (commits.length === 0) {
...
export function runtimeFromLegacyJson(sceneJson, options = {}) {
