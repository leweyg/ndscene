...
var FreedGoPrototype_State = {
    ...
    PreCoreSave : function() {
        this.Core.BoardName = "SomethingElse"
    },

    NewBoard : function() {
        this.Core.BoardName = "SomethingOne";
        this.Core.Turn = 0;
        this.Core.Nodes = []; 
        this.Core.Taken = [ 0, 0 ];
...
var FreedGoThreeJS_Prototype = {
    ...
    Build : function( contextObj ) {
        ...
        const piece_scale = 10.0; // 26 * this.Game.Board.NodeScale;
        ...
        const hard_node_count = 1;
        for (var ni=0; ni<hard_node_count; ni++) {
